...
# target 10.13
sed -i '.orig' s/\"10.9\"/\"10.13\"/ ./cmake/cef_variables.cmake
mkdir build
cd ./build
cmake -DCMAKE_CXX_FLAGS="-std=c++11 -stdlib=libc++ -Wno-error=deprecated-declarations" -DCMAKE_EXE_LINKER_FLAGS="-std=c++11 -stdlib=libc++" -DCMAKE_OSX_DEPLOYMENT_TARGET=10.13 ..
make -j4
mkdir libcef_dll
cd ../../
